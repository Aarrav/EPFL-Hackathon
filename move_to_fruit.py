# move_to_fruit.py - Move robot to a specified fruit position
...
# Fruit positions (same as before)
FRUIT_POSITIONS = {
...
def move_to_position(robot, ik_processor, target_pos, obs):
    ...
    time.sleep(2)
    return robot.get_observation()  # Update obs

def main():
    # Choose fruit (for testing, hardcode or input)
    fruit = input("Enter fruit class (red_fruit, yellow_fruit, green_fruit): ").strip()
    ...
    obs = move_to_position(robot, ik_processor, target_pos, obs)
...
if __name__ == "__main__":
    main()</content>
<parameter name="filePath">c:\Users\20242015\OneDrive - TU Eindhoven\Documents\EPFL hackathon\move_to_fruit.py